/*
Idea:
using 3 arrays to store front, end (of k size) - to keep track of front and end of a Queue &
next array (of size n ) to keep track of next element of each element.
*/
