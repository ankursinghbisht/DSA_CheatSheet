/*
Idea:
using 2 extra arrays to hold top element of each stack & next element of stack.
Inserting using top element and using next pointer array and while deleting -updating next element pointer.
*/
