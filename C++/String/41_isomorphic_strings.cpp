...
public:
    ...
    bool areIsomorphic(string str1, string str2)
    {
        ...
        //using map to store mapping of every character from str1 to that of str2. Initializing all entries of map as -1.
        int map[MAX_CHARS];
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (map[str1[i]] == -1)
            {
                //if current character of str2 is already seen, one to one mapping is not possible.
            ...
            //if this isn't first appearance of current character in str1 then checking if previous appearance mapped to same character of str2.
