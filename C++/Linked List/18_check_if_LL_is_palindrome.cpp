...
public:
    ...
    {
        //iterating over both lists and returning 0 if data at any node is not equal in both lists.
    ...
    bool isPalindrome(Node* head)
    {
        ...
        //now, we split list into 2 halves. In case of odd number of elements, first half will have the middle element.
        ...
        //we check whether both halves are identical (for odd number of elements first half will have one extra element).
