...
class Solution:
    def areAnagrams(self, root1: Optional['Node'], root2: Optional['Node']) -> bool:
        # Using a dictionary to store the frequency of each node value at each level
        mp = {}
        ...
        while q:
            ...
            mp[(root.data, level)] = mp.get((root.data, level), 0) + 1
        ...
        for value, frequency in mp.items():
            if frequency != 0:
